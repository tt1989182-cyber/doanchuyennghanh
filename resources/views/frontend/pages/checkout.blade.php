                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select name="country" id="country">
                                        <option value="Tỉnh" selected="selected">Tỉnh/ Thành Phố</option>
                                        <option value="CB">Cao Bằng</option>
                                        <option value="LC">Lai Châu</option>
                                        <option value="LCAI">Lào Cai</option>
                                        ...
                                        <option value="ĐN">TP. Đà Nẵng</option>
                ...
                <div class="col-lg-4 col-12">
                    <div class="order-details">
                        ...
                        <div class="single-widget">
                            ...
                            <div class="content">
                                <ul>
                                    ...
                                    @if(session('coupon'))
                                    <li class="coupon_price" data-price="{{session('coupon')['value']}}">Tiền được giảm <span>${{number_format(session('coupon')['value'],2)}}</span></li>
                                    @endif
                                    @php
                                    ...
                                    @endphp
                                    @if(session('coupon'))
                                    <li class="last" id="order_total_price">Tổng<span>{{ number_format((int)$total_amount, 0, ',', '.') }}đ
</span></li>
                                    @else
                                    <li class="last" id="order_total_price">Tổng<span>{{ number_format((int)$total_amount, 0, ',', '.') }}đ
</span></li>
                        ...
                        <div class="single-widget get-button">
                            <div class="content">
                                <div class="button">
                                    <button type="submit" class="btn">Hoàn thành thanh toán</button>
                                </div>
                            </div>
                        </div>
                        <!--/ End Button Widget -->
