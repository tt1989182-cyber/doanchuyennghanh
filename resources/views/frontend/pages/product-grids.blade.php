                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="shop-sidebar">
                                ...
                                <div class="single-widget recent-post">
                                    <h3 class="title">Bài đăng gàn đây</h3>
                                    {{-- {{dd($recent_products)}} --}}
...
duct->price,2)}}</del>   ${{number_format($org,2)}}  </p>
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                        <div class="quickview-content">
                                            ...
                                            @endphp
                                            <h3>
    <small><del class="text-muted">{{ number_format($product->price, 0, ',', '.') }} ₫</del></small>
...
@push('scripts')
    ...
    $("#slider-range").slider({
        ...
        slide: function (event, ui) {
            ...
            // ❗ Sửa biểu diễn giá tiền VND
            $("#amount").val(
                formatVND(ui.values[0]) + " - " + formatVND(ui.values[1])
            );

            // Giá trị raw gửi về server
