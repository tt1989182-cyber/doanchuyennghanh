                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="button-head">
                                                <div class="product-action">
                                                    <a data-toggle="modal" data-target="#{{$product->id}}" title="Quick View" href="#"><i class=" ti-eye"></i><span>Mua sắm</span></a>
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                <a href="{{route('product-detail',$product->slug)}}">
                                    ...
                                    <img class="default-img" src="{{$photo[0]}}" alt="{{$photo[0]}}">
                                    <img class="hover-img" src="{{$photo[0]}}" alt="{{$photo[0]}}">
                                    {{-- <span class="out-of-stock">Phổ biến</span> --}}
                                </a>
                                <div class="button-head">
                                    <div class="product-action">
...
<span>
    {{ number_format($after_discount, 0, ',', '.') }} ₫
</span>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-service">
                    ...
                    <p>Mua hàng trên 1 triệu đồng</p>
                </div>
                <!-- End Single Service -->
            </div>
            <div class="col-lg-3 col-md-6 col-12">
...
//* Banner full page – phù hợp website trang sức sang trọng */
.hero-banner {
    width: 100%;
    height: 450px; /* chiều cao banner đẹp */
    overflow: hidden;
    position: relative;
    border-radius: 0;
}
...
.hero-banner img {
    width: 100%;
    height: 100%;
    object-fit: cover;       /* luôn cover màn hình */
    object-position: center; /* căn giữa */
    filter: brightness(90%); /* nhẹ nhàng, tone sang */
}

@media (max-width: 768px) {
    .hero-banner {
        height: 280px; /* cho mobile */
    }
}
